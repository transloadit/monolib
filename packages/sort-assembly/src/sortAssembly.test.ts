...
import { sortAssembly } from './sortAssembly.ts'
...
describe('sortAssembly', () => {
  test('main', () => {
    const assembly = {
      ...
      assembly_ssl_url:
        'https://api2-jenks.transloadit.com/assemblies/7828446e5acd4aa996dce3455ec914e9',
      ...
      params:
        '{"steps":{":original":{"robot":"/upload/handle"},"faces_detected":{"use":":original","robot":"/image/facedetect","crop":true,"faces":"max-confidence","format":"preserve","crop_padding":"10%"},"exported":{"use":["faces_detected",":original"],"robot":"/s3/store","credentials":"demo_s3_credentials"}},"auth":{"key":"****","expires":"2020-01-10T12:02:05.826Z"}}',
      template: null,
      merged_params:
        '{"steps":{":original":{"robot":"/upload/handle"},"faces_detected":{"use":":original","robot":"/image/facedetect","crop":true,"faces":"max-confidence","format":"preserve","crop_padding":"10%"},"exported":{"use":["faces_detected",":original"],"robot":"/s3/store","credentials":"demo_s3_credentials"}},"auth":{"key":"****","expires":"2020-01-10T12:02:05.826Z"}}',
      ...
      uploads: [
        {
          ...
          is_tus_file: true,
          tus_upload_url:
            'https://api2-jenks.transloadit.com/resumable/files/f95ba7eebf22e0ebadcf9b09a3a91c65+DRCJv78IeFDneTwnYb3pagc8Bqg7IwlRAFpW8e3i.f4RSPIZXEeaxdheZiTBBvJ0pAyjxL3.U5TvUqWytvkObgz6Bh55biPZwLqzIK_mwRbjGl0UREMrju1zfy8.OgTg',
          url: 'http://demos.transloadit.com.s3.amazonaws.com/a3/0bd0776e7f4ac3817b056d102e8219/joe-gardner-149699.jpg',
          ssl_url:
            'https://s3.amazonaws.com/demos.transloadit.com/a3/0bd0776e7f4ac3817b056d102e8219/joe-gardner-149699.jpg',
          meta: {
            width: 2500,
            height: 1667,
