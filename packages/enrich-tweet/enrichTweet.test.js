...
describe('enrichTweet', () => {
  ...
  test('should render tweet 647088863777832961 correctly', async () => {
    ...
    expect((await enrichTweet(tweet))).toBe(`SponsorOfTheDay! We have giant love feelings for <a class="tweet-url username" href="https://twitter.com/transloadit" data-screen-name="transloadit" rel="nofollow">@transloadit</a>! And not just cuz that logo's cute as a bug. Thank you! <a href="https://pbs.twimg.com/media/CPrr5KQWwAAin58.png" rel="nofollow"><img class="tweet-media" src="https://pbs.twimg.com/media/CPrr5KQWwAAin58.png" /></a>`)
  })
  test.only('should render tweet 588610060810526720 correctly', async () => {
    jest.setTimeout(20000)
    const tweet = JSON.parse(fs.readFileSync(`${__dirname}/enrichTweet.fixture-588610060810526720.json`, 'utf-8'))
    expect((await enrichTweet(tweet))).toBe(`Trying to process/thumbnail about 600k avatars in a few hours. Thank you <a class=\"tweet-url username\" href=\"https://twitter.com/transloadit\" data-screen-name=\"transloadit\" rel=\"nofollow\">@transloadit</a> <a class=\"tweet-url username\" href=\"https://twitter.com/Prezly\" data-screen-name=\"Prezly\" rel=\"nofollow\">@Prezly</a> <a href=\"https://pbs.twimg.com/ext_tw_video_thumb/588609941604171776/pu/img/657mRahs1TNqS0vw.jpg\" rel=\"nofollow\"><img class="tweet-media" src="https://pbs.twimg.com/ext_tw_video_thumb/588609941604171776/pu/img/657mRahs1TNqS0vw.jpg" /></a>`)
  })
