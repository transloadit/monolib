...
describe('enrichTweet', () => {
  test('TWEET_1087761082247204900', async () => {
    ...
    expect((await enrichTweet(TWEET_1087761082247204900))).toBe(`In the age of cloud, <a class="tweet-url username" href="https://twitter.com/transloadit" data-screen-name="transloadit" rel="nofollow">@transloadit</a> shows great balance of leaning on larger clouds while managing infra in-house <a class="tweet-url username" href="https://twitter.com/kvz" data-screen-name="kvz" rel="nofollow">@kvz</a> \n<a href="https://transloadit.com/blog/2018/12/launching-asia-pacific-and-network-changes/" rel="nofollow">https://transloadit.com/blog/2018/12/launching-asia-pacific-and-network-changes/</a> <a href="https://pbs.twimg.com/media/DxiA8ElX4AA4hQ6.jpg" rel="nofollow"><img class="tweet-media" src="https://pbs.twimg.com/media/DxiA8ElX4AA4hQ6.jpg" /></a>`)
  })
  test('TWEET_1082897509528281089', async () => {
    ...
    expect((await enrichTweet(TWEET_1082897509528281089))).toBe(`Just realized how <a class="tweet-url username" href="https://twitter.com/tus_io" data-screen-name="tus_io" rel="nofollow">@tus_io</a> and <a class="tweet-url username" href="https://twitter.com/uppy_io" data-screen-name="uppy_io" rel="nofollow">@uppy_io</a> are a perfect example of <a class="tweet-url username" href="https://twitter.com/transloadit" data-screen-name="transloadit" rel="nofollow">@transloadit</a> commoditizing their complements: <a href="https://www.gwern.net/Complement" rel="nofollow">https://www.gwern.net/Complement</a>`)
  })
  ...
  test('TWEET_647088863777832961', async () => {
    ...
    expect((await enrichTweet(TWEET_647088863777832961))).toBe(`SponsorOfTheDay! We have giant love feelings for <a class="tweet-url username" href="https://twitter.com/transloadit" data-screen-name="transloadit" rel="nofollow">@transloadit</a>! And not just cuz that logo's cute as a bug. Thank you! <a href="https://pbs.twimg.com/media/CPrr5KQWwAAin58.png" rel="nofollow"><img class="tweet-media" src="https://pbs.twimg.com/media/CPrr5KQWwAAin58.png" /></a>`)
  })
  test('TWEET_17139572739674112', async () => {
    jest.setTimeout(20000)
    const TWEET_17139572739674112 = JSON.parse(fs.readFileSync(`${__dirname}/enrichTweet.fixture-17139572739674112.json`, 'utf-8'))
    expect((await enrichTweet(TWEET_17139572739674112))).toBe(`Encode your videos faster ! nice piece of technology : <a href=\"http://transloadit.com/blog/2010/12/realtime-encoding-over-150x-faster\" rel=\"nofollow\">http://transloadit.com/blog/2010/12/realtime-encoding-over-150x-faster</a> <a href=\"https://twitter.com/search?q=%23video\" title=\"#video\" class=\"tweet-url hashtag\" rel=\"nofollow\">#video</a> <a href=\"https://twitter.com/search?q=%23encoding\" title=\"#encoding\" class=\"tweet-url hashtag\" rel=\"nofollow\">#encoding</a>`)
  })
  test('TWEET_16955922978971648', async () => {
    jest.setTimeout(20000)
    const TWEET_16955922978971648 = JSON.parse(fs.readFileSync(`${__dirname}/enrichTweet.fixture-16955922978971648.json`, 'utf-8'))
    expect((await enrichTweet(TWEET_16955922978971648))).toBe(`Hey <a class="tweet-url username" href="https://twitter.com/YouTube" data-screen-name="YouTube" rel="nofollow">@YouTube</a>, <a class="tweet-url username" href="https://twitter.com/vimeo" data-screen-name="vimeo" rel="nofollow">@vimeo</a> and other video upload/sharing sites, offer <a class="tweet-url username" href="https://twitter.com/transloadit" data-screen-name="transloadit" rel="nofollow">@transloadit</a> a lot of money, now, quick <a href="http://news.ycombinator.com/item?id=2025354" rel="nofollow">http://news.ycombinator.com/item?id=2025354</a>`)
  })
  test('should not choke on undefined', async () => {
    jest.setTimeout(20000)
